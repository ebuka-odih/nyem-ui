    ...
    {isOpen && (
      <>
        ...
        <motion.div 
          ...
          className={`fixed bottom-0 left-0 right-0 bg-white rounded-t-[2.5rem] z-[210] p-6 pb-12 shadow-2xl ${fullHeight ? 'h-[92vh]' : 'max-h-[85vh]'} overflow-y-auto no-scrollbar max-w-[768px] mx-auto`}
        >
